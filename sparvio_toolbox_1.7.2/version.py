...
1.7.1  2023-06-08
       read_log.py tries to read lines again also for other exceptions,
       in particular "no reply".
       Fix bridge.py.

1.7.0  2023-05-10
       Add symbol humVPpm, etc, etc

1.6.1  2022-06-28
       Fix for read_log.py failing if the device doesn't have variable 'app'.

1.6.0  2022-05-15
       Add read_log.py argument maxadjust to limit or disable merging of
       lines with slightly different timestamps.
