...
parser.add_argument('--maxadjust', type=float, default=1.0,
                    help='Timestamps can be changed up to this many seconds to fit on the same line as other data ("0" to disable)')
...
def read_logs(loggerProxy, batch=1, maxadjust=1.0):
        ...
        while lines_so_far[0] < lineCount:
            ...
            try:
                ...
                if tries == 5:
                    ...
                    read_ok = False
                    break
                print(f'Exception {ex}. Trying again.')
                time.sleep(0.1)
                tries += 1
...
def main(args):
    ...
    try:
        ...
        if retain or not read_ok:
            ...
            print('Will format (this can take up to 1.5 minutes)')
